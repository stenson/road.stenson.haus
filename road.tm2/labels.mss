...
@sans: 'Calibre Light', 'Open Sans Regular', 'Arial Unicode MS Regular';
@sans_md: 'Calibre Semibold', 'Open Sans Semibold', 'Arial Unicode MS Regular';
@sans_bd: 'Calibre Black', 'Open Sans Bold','Arial Unicode MS Bold';
@sans_it: 'Calibre Light Italic', 'Open Sans Italic', 'Arial Unicode MS Regular';
...
#country_label[zoom>=2] {
  ...
  text-fill: #318528;
  text-halo-fill: fadeout(#abd0ad,80%);
  text-halo-radius: 1;
...
#place_label::citydots[type='city'][zoom>=4][zoom<=7][localrank<=3] {
  ...
  [ldir='NE'],[ldir='SE'],[ldir='SW'],[ldir='NW'] {
    ...
    shield-fill: #3c5336;
    shield-halo-fill: fadeout(#ebf2e8, 50%);
...
#place_label[zoom>=8][localrank<=3] {
  ...
  text-wrap-before: true;
  text-fill: #478e38;
  text-halo-fill: fadeout(#b7d0b6, 50%);
  text-halo-radius: 1;
  text-halo-rasterizer: fast;
  text-size: 10;
  text-line-spacing:-2;
